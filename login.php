                        ...
                        <div class="ps-form__content">
                            ...
                            <form id="form_login" name="form_login">
                                <div class="form-group">
                                    ...
                                    <input class="obligatorio form-control" type="text" id="login_email" name="login_email" placeholder="Correo electrónico">

                                </div>

                                <div class="form-group form-forgot">

                                    <input class="obligatorio form-control" type="text" id="login_password" name="login_password" placeholder="Contraseña">
